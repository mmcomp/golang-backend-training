...
func main() {
	...
	var id int64
	var name string = "AmirArsalan"
	var email string = "a.mirsamie@gmail.com"
	db.QueryRow("insert into accounts (name, email) values ($1, $2) returning id", name, email).Scan(&id)
